...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "Tab", function () awful.screen.focus_relative( 1) end,  
              {description = "focus the next screen", group = "screen"}),
    awful.key({ modkey,    altkey }, "l", function () awful.spawn.with_shell("multilockscreen --lock blur") end,  
    ...
    awful.key({ modkey, altkey    }, "m", function () awful.spawn.with_shell("~/.scripts/mpv-play") end,
            {description = "play link with MPV", group = "scripts"}),
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, altkey, "Shift" }, "q", function (c)
        if c.pid then
