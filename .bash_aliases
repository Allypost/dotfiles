...
alias youtube-dl="youtube-dl --http-chunk-size 10M --console-title --prefer-ffmpeg --netrc"
alias youtube-dl-best="youtube-dl -f bestvideo+bestaudio"

alias yt-dl="youtube-dl -f bestaudio --add-metadata --extract-audio --audio-format mp3 --audio-quality 0 -o '%(title)s.%(ext)s'"
alias y="yt-dl"
alias meme-dl="youtube-dl -f 'best[filesize <? 50M]' --id --embed-thumbnail --recode-video mp4 --add-metadata"
alias m="meme-dl"
